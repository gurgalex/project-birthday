...
var locationHook = ({base = ""} = {}) => {
  ...
  react.useEffect(() => {
    const checkForUpdates = () => {
      const pathname = currentPathname(base), hash = pathname + location.search;
  ...
  const navigate2 = react.useCallback((to, {replace = false} = {}) => history[replace ? eventReplaceState : eventPushState](null, "", to[0] === "~" ? to.slice(1) : base + to), [base]);
...
var useNavigate = (options) => {
  ...
  navRef.current = () => navigate2(options.to || options.href, options);
  return navRef;
};
var Router = (props) => {
...
var flattenChildren = (children) => {
  return Array.isArray(children) ? [].concat(...children.map((c) => c.type === react.Fragment ? flattenChildren(c.props.children) : flattenChildren(c))) : [children];
};
var Switch = ({children, location: location2}) => {
  ...
  for (const element of flattenChildren(children)) {
    let match = 0;
    if (react.isValidElement(element) && (match = element.props.path ? matcher(element.props.path, location2 || originalLocation) : [true, {}])[0])
...
var navigate = (to) => window.location.hash = to;
var useHashLocation = () => {
...
var NavBar = ({routes, appDispatch}) => {
  ...
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement("nav", null, renderedRoutes()));
};
...
var App = () => {
  ...
  return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(Router, {
    hook: useHashLocation
  }, /* @__PURE__ */ createElement(NavBar, {
    routes: navRoutes,
    appDispatch
  }), state.warnStorage && warningStorageContent, /* @__PURE__ */ createElement(Switch, null, /* @__PURE__ */ createElement(Route, {
    path: appRoutes.SETTINGS
  }, () => {
    return /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement(Settings, {
...
var warningStorageContent = /* @__PURE__ */ createElement(Fragment, null, /* @__PURE__ */ createElement("section", {
  id: "warning",
  style: warningStyle
}, /* @__PURE__ */ createElement("h2", null, "Warning: Not enough space on your device"), " ", /* @__PURE__ */ createElement("p", null, /* @__PURE__ */ createElement("b", null, "App will operate in read only mode."))));
var App_default = App;

// index.js
var root = document.getElementById("app");
react_dom_default.render(/* @__PURE__ */ createElement(App_default, null), root);
